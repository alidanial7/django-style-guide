...
Also consider edge rate limits at the reverse proxy for extra defense — see [Docker & production](docker-and-production.md).
...
| [APIs](apis.md) | Where to set throttle attrs |
| [API envelope](api-envelope.md) | 429 body shape |
| [Permissions](permissions.md) | Auth vs public |
| [Docker & production](docker-and-production.md) | Redis / proxy |
